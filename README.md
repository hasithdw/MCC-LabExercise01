...
{
  "name": "Hasith Dulanjana",
  "email": "hasithdulanjana@gmail.com.com",
...
{
  "name": "Hasith Updated",
  "email": "hasith.updated@example.com",
...
curl -X POST http://localhost:8081/students \
  ...
  -d '{"name":"Dulanjana Walimuni","email":"dulanjana@example.com","program":"Software Engineering"}'
```
...
curl -X POST http://localhost:8082/courses \
  -H "Content-Type: application/json" \
  -d '{"courseCode":"SE001","courseName":"Data Structures","credits":3,"instructor":"Dr. Nalaka"}'
```
...
curl -X POST http://localhost:8084/results \
  -H "Content-Type: application/json" \
  -d '{"studentId":1,"courseId":1,"grade":"A","score":90.5}'
```
